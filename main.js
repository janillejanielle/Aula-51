...
const pesquisarCep = async () => {
    ...
    try {
        ...
        if (await validarCep(cep_valor)) {
            ...
            const viacep_url = `https://viacep.combr/ws/${cep_valor}/json`
...
const preencherDados = async (endereço) => {
